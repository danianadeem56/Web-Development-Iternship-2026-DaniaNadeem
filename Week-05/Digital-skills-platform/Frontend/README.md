...
## Project Overview
Digital Skills Platform is a full-stack web application developed to support digital skills learning and management.This project focuses on the Instructor Dashboard, which allows instructors to manage courses, view registered students, monitor student progress, and manage student grades.
...
10. Backend Setup — YAHAN COMMANDS HONGI

Ab README mein ye section paste karo:
...
### Delete Course
![Delete Course](screenshots/delete-course.png)
...
### Delete Grade
![Delete Grade](screenshots/delete-grade.png)
...
## Author
Digital Skills Platform – Instructor Dashboard
Developed as an individual Week contribution for the Digital Skills Platform project.